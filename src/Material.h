...
public:
	...
	Vector3 getKd(const float u, const float v) const { return this->texture->getPixel(u, v); }
	Vector3 getKd(const Vector2& uv) const { return this->texture->getPixel(uv.c[0], uv.c[1]); }
